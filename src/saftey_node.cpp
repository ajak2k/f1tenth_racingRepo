...
//         scan_subscription = this->create_subscription<LaserScan>("/autodrive/f1tenth_1/lidar", 10, bind(&Safety::scan_callback, this, _1));

//         //Publisher to the car drive topic
//         //Publisher to the car drive topic
//         drive_speed_publisher = this->create_publisher<std_msgs::msg::Float32>("/autodrive/f1tenth_1/throttle_command", 10);
//     }
